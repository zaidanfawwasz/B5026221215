...
<html lang="en">
    ...
    <body class="d-flex flex-column h-100">
                        ...
                        <div class="col-xxl-7">
                            ...
                            <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                                <div class="profile bg-gradient-primary-to-secondary">
                                    <img class="profile-img" src="fotozaidan.png" alt="ini foto zaidan"/>
                                    <div class="dots-1">
                                        <!-- SVG Dots-->
        ...
        <!-- Footer-->
        <footer class="bg-white py-4 mt-auto footer-center">
            <div class="container px-5">
                <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                    <div class="col-auto">
                        <div class="small m-0">Copyright &copy; develop by <b>zaidanfawwasz</b></div>
                    </div>
                    <div class="col-auto">
                        <div class="small m-0">
                            <a href="{{ url('/company') }}" target="a_blank" ttext-decoration: none >Tugas 1   |</a>
                            <span style="display: inline-block; margin-right: 10px;">
                            <a href="{{ url('/sonderlab') }}" target="a_blank" ttext-decoration: none >   Tugas 2   |</a>
                            <span style="display: inline-block; margin-right: 10px;">
                            <a href="{{ url('/validasi') }}" target="a_blank" ttext-decoration: none > Tugas 3   |</a>
                            </span>
                        </div>
                    </div>
                </div>
